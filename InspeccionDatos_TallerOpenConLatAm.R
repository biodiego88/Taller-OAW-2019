#### Practica taller openCon LatAm 2019
#### Universidad Javeriana, 27 septiembre de 2019 
...
bd_alt <- read.csv("OrganizacionDatosBaseDatos_original.csv", sep = "", header = T)
head(bd_alt)

boxplot(PB ~ Poblado, data = bd_alt, xlab="Poblado", ylab="Deforestacion (ha)", 
        notch=F, outline=F)
